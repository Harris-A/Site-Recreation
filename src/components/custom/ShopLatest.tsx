...
export default function ShopLatest () {
    return (
        <>
            <h1 className="tracking-in-expand-fwd-bottom shop-heading px-16 uppercase text-[10rem] text-center leading-none font-extrabold tracking-tighter mb-6">discover the best</h1>
