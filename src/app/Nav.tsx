                ...
                >
                    <div className="flex justify-center min-h-screen relative">
                        ...
                        <div className="flex flex-col items-center justify-center gap-8 uppercase">
                            <Link href="#" size="9" underline="none" color="gray" className="hover:text-black hover:border-b-2 hover:border-black dark:hover:text-white ">Shop</Link>
                            ...
                            <Link href="/login" size="9" underline="none" color="gray" className="hover:text-black dark:hover:text-white">Account</Link>
                        </div>
                    </div>
                </motion.div>
            )}
